...
## Project Structure
    ...
    ├── towcom_roadside_36383  # Django project configurations
...
1. Clone this repo and `cd towcom_roadside_36383`
...
2. Clone this repo and `cd towcom_roadside_36383`
